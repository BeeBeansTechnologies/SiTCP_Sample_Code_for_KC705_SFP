...
set_property IOSTANDARD LVCMOS25 [get_ports {DIP[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {DIP[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {DIP[2]}]
set_property IOSTANDARD LVCMOS25 [get_ports {DIP[3]}]
...
set_property PACKAGE_PIN Y29 [get_ports {DIP[0]}]
set_property PACKAGE_PIN W29 [get_ports {DIP[1]}]
set_property PACKAGE_PIN AA28 [get_ports {DIP[2]}]
set_property PACKAGE_PIN Y28 [get_ports {DIP[3]}]
